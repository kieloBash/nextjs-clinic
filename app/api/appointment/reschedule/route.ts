            ...
            await Promise.all([
                ...
                createNotification({
                    ...
                    email: {
                        ...
                        htmlContent: `<p>Hi ${existingAppointment.patient.name}, your appointment with Dr. ${existingAppointment.doctor.name} has been successfully rescheduled to ${newTimeSlot.date.toDateString()} from ${newTimeSlot.startTime.toLocaleTimeString()} to ${newTimeSlot.endTime.toLocaleTimeString()}.</p>`,
                    },
                }),
                createNotification({
                    tx,
                    ...
                    email: {
                        ...
                        subject: "Appointment Rescheduled",
                        htmlContent: `<p>Hi Dr. ${existingAppointment.doctor.name}, the appointment with ${existingAppointment.patient.name} has been successfully rescheduled to ${newTimeSlot.date.toDateString()} from ${newTimeSlot.startTime.toLocaleTimeString()} to ${newTimeSlot.endTime.toLocaleTimeString()}.</p>`,
                    },
                }),
            ]);
